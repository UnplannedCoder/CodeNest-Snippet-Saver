        ...
        <div className='flex flex-col gap-4 sm:gap-6 w-full max-w-3xl mx-auto mb-4 sm:mb-6'>
            ...
            <div className={`border-2 rounded-2xl w-full flex flex-col overflow-hidden shadow-xl transition-colors duration-300 ${
                ...
                <div className={`p-2 flex flex-col transition-colors duration-300 ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
                    <textarea
                    className={`home-textarea w-full outline-none p-3 sm:p-4 font-mono text-sm sm:text-base md:text-lg resize-none min-h-[260px] sm:min-h-[380px] md:min-h-[460px] max-h-[55vh] sm:max-h-[65vh] overflow-y-auto transition-colors duration-300 ${
