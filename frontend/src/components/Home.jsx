  ...
  return (
    <div className='flex flex-col items-center w-full px-3 sm:px-4 md:px-6 pt-2 sm:pt-4 pb-4 sm:pb-8 max-w-3xl mx-auto'>
        <div className='flex flex-col gap-2.5 sm:gap-4 w-full'>
            ...
            {/* Top Control Bar */}
            <div className='flex flex-col gap-2 sm:flex-row sm:gap-4 justify-between w-full items-stretch sm:items-center shrink-0'>
                <input 
                className={`border-2 p-2.5 sm:p-3 px-3.5 sm:px-4 rounded-xl sm:rounded-2xl w-full outline-none text-sm sm:text-lg font-semibold shadow-sm transition-colors duration-300 ${
                    isDarkMode 
                ...
                className={`border-2 px-5 sm:px-8 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl font-semibold transition whitespace-nowrap shadow-sm w-full sm:w-auto text-sm sm:text-base ${
                    isDarkMode 
            ...
            <div className={`border-2 rounded-xl sm:rounded-2xl w-full flex flex-col shadow-xl overflow-hidden transition-colors duration-300 ${
                ...
                <div className={`p-2 flex flex-col transition-colors duration-300 ${isDarkMode ? 'bg-black' : 'bg-white'}`}>
                    <textarea
                    className={`home-textarea w-full outline-none p-2.5 sm:p-4 font-mono text-xs sm:text-base md:text-lg resize-none h-[35vh] sm:h-[48vh] md:h-[55vh] min-h-[220px] max-h-[340px] sm:max-h-[520px] overflow-y-auto transition-colors duration-300 ${
